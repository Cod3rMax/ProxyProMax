...
<x-main-proxieslist-top-title :title1="'USA Free Proxy List'" :title2="'All our UNITED STATES checked free proxy list in one page.'"></x-main-proxieslist-top-title>
    ...
    <div id="our-story" class="crumina-breadcrumbs breadcrumbs--dark-themes">
        <div class="container">
         ...
         <div id="app">
            <usaproxies-component :login-route="'{{ Route('UserLogin') }}'" :allproxies-route="'{{ Route('UsaProxiesAPI') }}'" :is-user-logged="'{{ Auth::check() }}'"></usaproxies-component>
         </div>
