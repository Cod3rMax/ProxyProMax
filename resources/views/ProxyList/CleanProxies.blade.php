...
<x-main-proxieslist-top-title :title1="'Clean Free Proxy List'" :title2="'All our Clean checked free proxy list in one page.'"></x-main-proxieslist-top-title>
    ...
    <div id="our-story" class="crumina-breadcrumbs breadcrumbs--dark-themes">
        <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="breadcrumbs">
                        ...
                        <li class="breadcrumbs-item active">
                            <span>Clean Free Proxy List</span>
                        </li>
                    </ul>
                </div>
            </div>
         ...
         <div id="app">
            <cleanproxies-component :login-route="'{{ Route('UserLogin') }}'" :allproxies-route="'{{ Route('CleanProxiesAPI') }}'" :is-user-logged="'{{ Auth::check() }}'"></cleanproxies-component>
         </div>
