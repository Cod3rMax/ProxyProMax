...
Route::get('ProxyList/UsaProxies',[ProxiesController::class,'GetUsaProxies'])->name('UsaProxiesAPI');
Route::get('ProxyList/CleanProxies',[ProxiesController::class,'GetCleanProxies'])->name('CleanProxiesAPI');
